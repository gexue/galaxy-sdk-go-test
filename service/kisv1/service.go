...
// Kisv1 provides the API operation methods for making requests to
// kisv1. See this package's package overview docs
// for details on the service.
//
// Kisv1 methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the Kisv1 client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *Kisv1 {
	svc := &Kisv1{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a Kisv1 operation and runs any
// custom request initialization.
func (c *Kisv1) newRequest(op *request.Operation, params, data interface{}) *request.Request {
