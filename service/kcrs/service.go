...
// Kcrs provides the API operation methods for making requests to
// kcrs. See this package's package overview docs
// for details on the service.
//
// Kcrs methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the Kcrs client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *Kcrs {
	svc := &Kcrs{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a Kcrs operation and runs any
// custom request initialization.
func (c *Kcrs) newRequest(op *request.Operation, params, data interface{}) *request.Request {
