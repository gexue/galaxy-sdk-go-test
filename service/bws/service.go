...
// Bws provides the API operation methods for making requests to
// bws. See this package's package overview docs
// for details on the service.
//
// Bws methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the Bws client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *Bws {
	svc := &Bws{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a Bws operation and runs any
// custom request initialization.
func (c *Bws) newRequest(op *request.Operation, params, data interface{}) *request.Request {
