...
// Tagv2 provides the API operation methods for making requests to
// tagv2. See this package's package overview docs
// for details on the service.
//
// Tagv2 methods are safe to use concurrently. It is not safe to
...
// New creates a new instance of the Tagv2 client with a session.
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *Tagv2 {
	svc := &Tagv2{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a Tagv2 operation and runs any
// custom request initialization.
func (c *Tagv2) newRequest(op *request.Operation, params, data interface{}) *request.Request {
